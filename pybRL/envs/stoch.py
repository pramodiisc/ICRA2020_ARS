...
class Stoch(object):
  ...
  """
    ...
    """
        self.num_motors = 14
        self.num_legs = int(self.num_motors / 2 - 3)
        ...
        if reload_urdf:
            ...
            if self._self_collision_enabled:
                self.quadruped = self._pybullet_client.loadURDF(
                    os.path.realpath('../..') + '/pybRL/envs/stoch_two_abduction_urdf/urdf/stoch_two_abduction_urdf.urdf',
                    INIT_POSITION,
                    flags=self._pybullet_client.URDF_USE_SELF_COLLISION)
            else:
                self.quadruped = self._pybullet_client.loadURDF(
                    os.path.realpath('../..') + '/pybRL/envs/stoch_two_abduction_urdf/urdf/stoch_two_abduction_urdf.urdf',
                    INIT_POSITION)  # , flags=self._pybullet_client.URDF_USE_MATERIAL_COLORS_FROM_MTL)
    ...
    def _ResetPoseForAbd(self):
        ...
        if self._accurate_motor_model_enabled or self._pd_control_enabled:
            ...
            self._SetDesiredMotorAngleByName("motor_front_left_abd_joint", 0)
            self._SetDesiredMotorAngleByName("motor_front_right_abd_joint", 0)
            self._SetDesiredMotorAngleByName("motor_back_left_abd_joint", 0)
            self._SetDesiredMotorAngleByName("motor_back_right_abd_joint", 0)
